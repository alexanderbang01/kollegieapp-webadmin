...
// Tjek om edit mode er aktiveret
        ...
        <main class="flex-grow">
            ...
            <div class="p-3 sm:p-6">
                ...
                <?php else: ?>
                    ...
                    <!-- Edit form -->
                    <form id="edit-form" method="post" action="save_foodplan.php">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                            ...
                            <!-- Thursday Edit - kan redigeres men med standardværdier -->
                            <div class="bg-white rounded-xl shadow animate-fade-in">
                                <div class="p-3 sm:p-4 border-b border-gray-100 <?php echo ($current_day == 'thursday') ? 'bg-primary/10' : ''; ?>">
                                    <h3 class="font-bold text-primary">Torsdag <span class="text-gray-500"><?php echo $dates['thursday']; ?></span></h3>
                                </div>
                                <div class="p-3 sm:p-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="thursday_description" name="thursday_description" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50"><?php echo $foodplan && isset($foodplan['thursday_description']) ? $foodplan['thursday_description'] : 'Varme rester fra ugens retter.'; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="flex items-center gap-2 text-sm">
                                    ...
                                    <div class="mt-3 p-2 bg-blue-50 rounded-lg">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-blue-800 text-xs">Standard: "Det lune bord" med rester</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        <?php if (!$edit_mode): ?>
            editBtn.addEventListener('click', () => {
                window.location.href = `?week=<?php echo $current_week; ?>&year=<?php echo $current_year; ?>&edit=true`;
            });
        <?php endif; ?>

        <?php if ($edit_mode): ?>
            cancelBtn.addEventListener('click', () => {
                window.location.href = `?week=<?php echo $current_week; ?>&year=<?php echo $current_year; ?>`;
            });
            ...
            placeholderBtn.addEventListener('click', (e) => {
                ...
                const placeholderMeals = {
                    ...
                    'thursday': {
                        'dish': 'Det lune bord',
                        'description': 'Varme rester fra ugens retter.',
                        'vegetarian': false,
                        'allergens': [] // Ingen faste allergener
                    }
                };

                // Udfyld felterne med standard madplan (alle dage)
                ...
                // Inkluder torsdag i placeholder
                ...
                // Torsdag har ingen allergener som standard
        ...
        prevWeekBtn.addEventListener('click', () => {
            ...
            window.location.href = `?week=${currentWeek}&year=${currentYear}${editParam}`;
        });
