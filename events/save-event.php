...
function createEventNotification($conn, $event_id, $title, $date, $time, $created_by) {
   try {
       $notification_title = "Ny begivenhed: $title";
       $notification_content = "Der er oprettet en ny begivenhed d. $date kl. $time.";
...
try {
   ...
   if ($event_id) {
       ...
       if ($stmt->affected_rows > 0) {
           // Log aktivitet for opdateret begivenhed
           logActivity($conn, $created_by, 'event_updated', "Opdaterede begivenheden: $title");
       ...
       if ($stmt->affected_rows === 1) {
           ...
           createEventNotification($conn, $new_event_id, $title, $date, $time, $created_by);
           
           // Log aktivitet for ny begivenhed
           logActivity($conn, $created_by, 'event_created', "Oprettede ny begivenhed: $title");
