        ...
        <main class="flex-grow">
            ...
            <div class="p-3 sm:p-6">
                <div class="mb-4 sm:mb-6 flex justify-between items-center">
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Opret nyhed</h1>
                        <p class="text-sm sm:text-base text-gray-600">Tilføj en ny nyhed eller meddelelse til kollegiet</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-6 animate-fade-in">
                    <form id="create-news-form" action="save-news.php" method="POST" class="space-y-6">
